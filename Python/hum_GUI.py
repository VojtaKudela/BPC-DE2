...
class hum_GUI(ckt.CTk):
    ...
    def createGUI(self):
        ...
        self.entry_00=ckt.CTkEntry(master=self,placeholder_text=str(self.master.setting['hum_val']),width=70,font=('Arial',20))
        self.entry_00.place(relx=0.72,rely=0.2,anchor='w')
        self.entry_01=ckt.CTkEntry(master=self,placeholder_text=str(self.master.setting['hum_hys']),width=70,font=('Arial',20))
